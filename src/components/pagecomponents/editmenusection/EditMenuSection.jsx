...
function EditMenuSection({ cancel, editdata }) {
  const inputField = [
    {
      title: "name",
      type: "text",
              ...
              return (
                <Form className="flex flex-col   text-left h-[480px] gap-5   w-full justify-center mx-auto  ">
                  ...
                  <div className="w-full flex  gap-5 justify-center  ">
                    <button
                      type="submit"
                      className=" w-5/12  p-1  bg-gray-500 uppercase text-lg font-medium rounded cursor-pointer hover:text-white hover:bg-gray-600 transition"
                    >
                      Submit
                    </button>
                    <button
                      onClick={cancel}
                      type="button"
                      className=" w-5/12  p-1  bg-red-700 text-white uppercase text-lg font-medium rounded cursor-pointer "
                    >
                      cancel
                    </button>
                  </div>
