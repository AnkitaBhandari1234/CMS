      ...
      <Toaster/>
                       ...
                       <div className="lg:grid lg:grid-cols-10 flex flex-col gap-4 mx-3 px-3  ">
                         <div className="col-span-3 ">
                           <h1 className=" text-xl  font-medium  ">Service Offer</h1>
                           <h2>[title,sub-title,image,foodname,description]</h2>
                         </div>
                           ...
                           <div className=" ">
                             ...
                             >
                               {({ setFieldValue, values }) => {
                                 return (
                                   <Form className="flex flex-col gap-4 items-center h-[640px]   w-full  ">
