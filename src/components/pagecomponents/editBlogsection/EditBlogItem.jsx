...
function EditBlogItem({cancel}) {
  ...
  return (
                      ...
                      <div className=" bg-gray-800 w-6/12 h-lvh flex items-center justify-center mx-auto overflow-y-scroll ">
                        <Formik
                         
                        >
                          {({ setFieldValue, values }) => {
                            return (
                              <Form className="flex flex-col gap-4  items-center h-[550px]   w-full   ">
                                {inputField.map((val, i) => {
                                  if (val.type == "file") {
                                    return (
                                      ...
                                      >
                                        <label className='pl-14'>{val.title}</label>
                                        <input
                                          type={val.type}
                                          id={val.title}
                                          name={val.title}
                                        ...
                                        <label htmlFor={val.title} className='pl-13'>
                                    ...
                                    return (
                                      <div key={i} className="w-full  ">
                                        <div className="capitalize text-xl flex flex-col text-left text-white ">
                                          <label className='pl-13'>{val.title}</label>
                                        </div>
                                        <Field
                                          type={val.type}
                                          id={val.title}
